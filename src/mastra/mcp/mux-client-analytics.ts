...
class MuxMCPClient {
    ...
    private async ensureConnected(): Promise<void> {
        ...
        // Parse MCP args from environment variable (support two names)
        const rawArgs = process.env.MUX_MCP_ANALYTICS_ARGS || process.env.MUX_MCP_INTERACTIVE_ARGS;
        const mcpArgs = rawArgs
